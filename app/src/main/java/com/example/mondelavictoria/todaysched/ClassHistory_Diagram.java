...
/**
 * Created by Rey Dela Victoria on 9/29/2018.
 */

public class ClassHistory_Diagram extends SuperClass_Scheduler{
    private int id;
    ...
    public ClassHistory_Diagram(){}


    public ClassHistory_Diagram(int id,String subject,String location, String startTime, String endTime, String date, String alertTime, String hourStart,
